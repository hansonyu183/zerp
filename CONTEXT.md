...
_Rules_: [BOB 连续生效](docs/domains/bob.md#42-草稿编辑连续生效与历史版本冻结)、[AUX 统一生命周期](docs/domains/aux.md#2-统一生命周期)、[APP 菜单模板](docs/domains/app.md#39-菜单模板)
...
_Rules_: [BOB 车辆承运归属](docs/domains/bob.md#24-车辆承运归属)
