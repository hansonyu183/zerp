...
const auxWriteShapes = {
  ...
  employee: {
    ...
    legalIdentifier: z.string().max(128).default(''),
    contactName: z.string().max(100),
    phone: z.string().max(32),
    address: z.string().max(500),
    employeeCategoryId: identifierShape.id.nullable().default(null),
    departmentId: identifierShape.id.nullable().default(null),
    positionId: identifierShape.id.nullable().default(null),
    employmentDate: z.union([z.string().date(), z.literal('')]).default(''),
    workPhone: z.string().max(32),
    workEmail: z.string().max(320),
    operatingEntityId: identifierShape.id.nullable().default(null),
    remark: z.string().max(1000),
  },
  warehouse: {
    ...nameShape,
...
export const auxCurrentDataSchemas = {
  ...
  employee: z
    .object({
      ...employeeCurrentDataShape,
      employeeCategory: currentSnapshot.nullable(),
      department: currentSnapshot.nullable(),
      position: currentSnapshot.nullable(),
      operatingEntity: currentSnapshot.nullable(),
    })
    .strict(),
