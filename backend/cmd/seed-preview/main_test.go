...
func TestIsManagedPreviewDatabase(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "postgres loopback prefix", database: "zerp_preview_pr_164", user: "zerp_preview", host: "127.0.0.1/32", port: 55436, want: true},
		...
		{name: "loopback network", database: "zerp_preview", user: "zerp_preview", host: "127.0.0.1/24", port: 55436, want: false},
