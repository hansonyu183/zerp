-- Pre-#305 database fixture.
--
-- Purpose: provide validated, frozen input for the #305 architecture cutover,
-- independently of later changes to db/schema.sql. The snapshot includes
-- representative DCL approvals plus the BOB identity and current tables that
-- #305 removes. Provenance: main at c9099f5e; this comment is documentary.
...
-- Representative #305 cutover input. V1 is approved and copied into BOB
-- current storage; V2 is pending and must not replace that current row. The
...
INSERT INTO public.approval_entries (
    ...
    ('01Z30500000000000000000002', 'dcl', 'operating-entity', '01Z30500000000000000000001', 1, 'APPROVED', 3,
     '01JAPPSYST3MACTR0000000000', '2026-08-29 03:00:00+00', '01JAPPSYST3MACTR0000000000', '2026-08-29 03:02:00+00',
     '00000000000000000000000000', '2026-08-29 03:01:00+00', '01JAPPSYST3MACTR0000000000', '2026-08-29 03:02:00+00'),
    ('01Z30500000000000000000006', 'dcl', 'operating-entity', '01Z30500000000000000000001', 2, 'PENDING', 2,
     '01JAPPSYST3MACTR0000000000', '2026-08-29 03:03:00+00', '01JAPPSYST3MACTR0000000000', '2026-08-29 03:04:00+00',
     '00000000000000000000000000', '2026-08-29 03:04:00+00', NULL, NULL);

INSERT INTO public.dcl_operating_entity_versions (
    approval_entry_id, legal_name, short_name, tax_number, address, phone, remark, enabled
) VALUES
    ('01Z30500000000000000000002', 'Issue 305 Operating Entity V1', 'Issue 305 V1', 'TAX-305-V1', 'Fixture address V1', '0305', 'approved baseline', true),
    ('01Z30500000000000000000006', 'Issue 305 Operating Entity V2', 'Issue 305 V2', 'TAX-305-V2', 'Fixture address V2', '0306', 'pending candidate', true);

INSERT INTO public.approval_events (
    id, entry_id, domain, entity, subject_id, version_no, action,
    from_status, to_status, from_revision, to_revision, actor_id, reason, request_id, created_at
) VALUES
    ('01Z30500000000000000000003', '01Z30500000000000000000002', 'dcl', 'operating-entity', '01Z30500000000000000000001', 1,
     'CREATED', NULL, 'DRAFT', NULL, 1, '01JAPPSYST3MACTR0000000000', NULL, 'issue-305-fixture-v1-created', '2026-08-29 03:00:00+00'),
    ('01Z30500000000000000000004', '01Z30500000000000000000002', 'dcl', 'operating-entity', '01Z30500000000000000000001', 1,
     'SUBMITTED', 'DRAFT', 'PENDING', 1, 2, '00000000000000000000000000', NULL, 'issue-305-fixture-v1-submitted', '2026-08-29 03:01:00+00'),
    ('01Z30500000000000000000005', '01Z30500000000000000000002', 'dcl', 'operating-entity', '01Z30500000000000000000001', 1,
     'APPROVED', 'PENDING', 'APPROVED', 2, 3, '01JAPPSYST3MACTR0000000000', NULL, 'issue-305-fixture-v1-approved', '2026-08-29 03:02:00+00');

INSERT INTO public.bob_objects (
    id, entity, code, revision, created_at, created_by, updated_at, updated_by, enabled
) VALUES (
    '01Z30500000000000000000001', 'operating-entity', 'ENT-0305', 7,
    '2026-08-29 03:00:00+00', '01JAPPSYST3MACTR0000000000',
    '2026-08-29 03:02:00+00', '01JAPPSYST3MACTR0000000000', true
);

INSERT INTO public.bob_operating_entities (
    object_id, source_approval_entry_id, legal_name, short_name, tax_number,
    address, phone, remark, enabled, updated_at, updated_by
) VALUES (
    '01Z30500000000000000000001', '01Z30500000000000000000002',
    'Issue 305 Operating Entity V1', 'Issue 305 V1', 'TAX-305-V1',
    'Fixture address V1', '0305', 'approved baseline', true,
    '2026-08-29 03:02:00+00', '01JAPPSYST3MACTR0000000000'
);
