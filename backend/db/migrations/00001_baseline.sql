...
CREATE TABLE public.app_business_menu_items (
    ...
    snapshot_type character varying(16) DEFAULT 'DRAFT'::character varying NOT NULL,
    ...
    CONSTRAINT app_business_menu_items_revision_check CHECK ((revision > 0)),
    ...
    CONSTRAINT app_business_menu_items_snapshot_type_check CHECK (((snapshot_type)::text = ANY ((ARRAY['DRAFT'::character varying, 'PUBLISHED'::character varying])::text[]))),
...
CREATE TABLE public.app_feedback (
    ...
    page_path character varying(256),
    client_version character varying(64),
    related_request_id character varying(128),
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT app_feedback_attempt_count_check CHECK (((attempt_count >= 0) AND (attempt_count <= 10))),
    CONSTRAINT app_feedback_category_check CHECK (((category)::text = ANY ((ARRAY['BUG'::character varying, 'SUGGESTION'::character varying, 'OTHER'::character varying])::text[]))),
    CONSTRAINT app_feedback_content_check CHECK (((length(btrim((content)::text)) >= 1) AND (length(btrim((content)::text)) <= 4000))),
    CONSTRAINT app_feedback_publication_ck CHECK (((((status)::text = 'PUBLISHED'::text) AND (github_issue_number IS NOT NULL) AND (github_issue_url IS NOT NULL) AND (published_at IS NOT NULL)) OR (((status)::text <> 'PUBLISHED'::text) AND (github_issue_number IS NULL) AND (github_issue_url IS NULL) AND (published_at IS NULL)))),
    CONSTRAINT app_feedback_status_check CHECK (((status)::text = ANY ((ARRAY['PENDING'::character varying, 'PROCESSING'::character varying, 'PUBLISHED'::character varying, 'FAILED'::character varying])::text[]))),
    CONSTRAINT app_feedback_title_check CHECK (((length(btrim((title)::text)) >= 1) AND (length(btrim((title)::text)) <= 120)))
);


--
-- Name: app_feedback_attachments; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.app_feedback_attachments (
    ...
    source character varying(16) DEFAULT 'VOU'::character varying NOT NULL,
    CONSTRAINT app_feedback_attachments_declared_size_check CHECK (((declared_size >= 1) AND (declared_size <= 10485760))),
    CONSTRAINT app_feedback_attachments_position_check CHECK ((("position" >= 1) AND ("position" <= 3))),
    CONSTRAINT app_feedback_attachments_sha256_hex_check CHECK ((sha256_hex ~ '^[0-9a-f]{64}$'::text)),
    CONSTRAINT app_feedback_attachments_source_check CHECK (((source)::text = ANY ((ARRAY['VOU'::character varying, 'FEEDBACK'::character varying])::text[])))
);


--
-- Name: app_feedback_files; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.app_feedback_files (
    id character varying(26) NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    created_by character varying(26) NOT NULL,
    CONSTRAINT app_feedback_files_content_type_check CHECK (((content_type)::text = ANY ((ARRAY['image/png'::character varying, 'image/jpeg'::character varying])::text[]))),
    CONSTRAINT app_feedback_files_declared_size_check CHECK (((declared_size >= 1) AND (declared_size <= 10485760))),
    CONSTRAINT app_feedback_files_sha256_hex_check CHECK ((sha256_hex ~ '^[0-9a-f]{64}$'::text)),
    CONSTRAINT app_feedback_files_state_ck CHECK (((((status)::text = 'PENDING'::text) AND (stored_at IS NULL) AND (removed_at IS NULL)) OR (((status)::text = 'READY'::text) AND (stored_at IS NOT NULL) AND (removed_at IS NULL)) OR (((status)::text = 'DELETED'::text) AND (removed_at IS NOT NULL)))),
    CONSTRAINT app_feedback_files_status_check CHECK (((status)::text = ANY ((ARRAY['PENDING'::character varying, 'READY'::character varying, 'DELETED'::character varying])::text[]))),
    CONSTRAINT app_feedback_files_upload_token_hash_check CHECK ((upload_token_hash ~ '^[0-9a-f]{64}$'::text))
);
...
CREATE TABLE public.bob_audit_events (
    ...
    request_id character varying(128) NOT NULL,
    summary jsonb DEFAULT '{}'::jsonb NOT NULL,
    CONSTRAINT bob_audit_events_event_type_check CHECK (((event_type)::text = ANY ((ARRAY['CREATED'::character varying, 'EDIT_STARTED'::character varying, 'SAVED'::character varying, 'SUBMITTED'::character varying, 'UNSUBMITTED'::character varying, 'APPROVED'::character varying, 'UNAPPROVED'::character varying, 'REJECTED'::character varying, 'INVALIDATED'::character varying, 'ENABLED'::character varying, 'DISABLED'::character varying, 'BULK_BOB_REFERENCE_TRANSFERRED'::character varying, 'WAREHOUSE_MANAGER_CLEARED'::character varying])::text[]))),
...
-- +goose StatementBegin
INSERT INTO public.app_business_menu_items VALUES ('menu-group-sales', NULL, 'GROUP', 1, 20, '销售', 'mdi-cart-arrow-up', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-purchase', NULL, 'GROUP', 1, 30, '采购', 'mdi-cart-arrow-down', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-production', NULL, 'GROUP', 1, 40, '生产', 'mdi-factory', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-inventory', NULL, 'GROUP', 1, 50, '库存', 'mdi-warehouse', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-cash', NULL, 'GROUP', 1, 60, '出纳', 'mdi-cash-register', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-assets', NULL, 'GROUP', 1, 70, '资产', 'mdi-office-building-cog-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-people', NULL, 'GROUP', 1, 80, '人事', 'mdi-account-group-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-accounting', NULL, 'GROUP', 1, 90, '会计', 'mdi-calculator-variant-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-master-data', NULL, 'GROUP', 1, 100, '基础资料', 'mdi-database-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-auxiliary-data', NULL, 'GROUP', 1, 110, '辅助资料', 'mdi-shape-plus-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-workflow', NULL, 'GROUP', 1, 120, '业务流程', 'mdi-transit-connection-variant', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-system', NULL, 'GROUP', 1, 130, '系统管理', 'mdi-cog-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-3bd625b1e4fab7df6ca50ededc2b5db4', 'menu-group-cash', 'ROUTE', 2, 80, '资金账户', NULL, true, 'bob/fund-account', '/bob/fund-account/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-f5250d63a2a164f7ab3703650939dae5', 'menu-group-cash', 'ROUTE', 2, 110, '往来收款', NULL, true, 'vou/other-receipt', '/vou/other-receipt/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-cf1ab6d8cbdc6e4beee674f9ba74331a', 'menu-group-cash', 'ROUTE', 2, 140, '往来付款', NULL, true, 'vou/other-payment', '/vou/other-payment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-ed48b9ae73d1aae5d62dd030697d2d60', 'menu-group-cash', 'ROUTE', 2, 150, '往来付款', NULL, true, 'vou/employee-loan', '/vou/employee-loan/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-other', NULL, 'GROUP', 1, 140, '其他/待归类', 'mdi-folder-question-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-5edfba69a6100b8246936882a6e6a1d1', 'menu-group-assets', 'ROUTE', 2, 10, '资产类别', NULL, true, 'aux/asset-category', '/aux/asset-category/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-5621c6b304b4ec1972f3d7c27222b7c0', 'menu-group-assets', 'ROUTE', 2, 30, '资产购置', NULL, true, 'vou/asset-acquisition', '/vou/asset-acquisition/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-8c2412de41df776a1ef186259b3c46ed', 'menu-group-assets', 'ROUTE', 2, 50, '资产出让', NULL, true, 'vou/asset-sale', '/vou/asset-sale/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-cf273e60bdbf0735892f65eae282f163', 'menu-group-purchase', 'ROUTE', 2, 20, '采购询价', NULL, true, 'vou/purchase-inquiry', '/vou/purchase-inquiry/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-master-data', NULL, 'GROUP', 1, 100, '基础资料', 'mdi-database-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-55273dfb397671aa5cfde1201e988317', 'menu-group-assets', 'ROUTE', 2, 60, '资产清算', NULL, true, 'vou/asset-liquidation', '/vou/asset-liquidation/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-7ef455e8d909e2c169bbad72746120d3', 'menu-group-auxiliary-data', 'ROUTE', 2, 10, '产品分类', NULL, true, 'aux/product-category', '/aux/product-category/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-210f05f5c6eba36e5c3a1085fd060a0b', 'menu-group-auxiliary-data', 'ROUTE', 2, 20, '产品类型', NULL, true, 'aux/product-type', '/aux/product-type/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-ee125d1adcda16c0f5e7dce3a1b29c15', 'menu-group-auxiliary-data', 'ROUTE', 2, 30, '计量单位', NULL, true, 'aux/measurement-unit', '/aux/measurement-unit/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-7b6b7779632846a5bd990848e5fb1e88', 'menu-group-auxiliary-data', 'ROUTE', 2, 40, '字典类型', NULL, true, 'aux/dictionary-type', '/aux/dictionary-type/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-529365f0788ee2f5849d2bccf82a5e11', 'menu-group-auxiliary-data', 'ROUTE', 2, 50, '字典项', NULL, true, 'aux/dictionary-item', '/aux/dictionary-item/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-ab6bba0d23a92d0d1c3d4d74ff86c3ae', 'menu-group-auxiliary-data', 'ROUTE', 2, 60, '收支类型', NULL, true, 'aux/income-expense-type', '/aux/income-expense-type/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-3e2ff8ddac4aa25630156b745c869757', 'menu-group-cash', 'ROUTE', 2, 160, '往来收款', NULL, true, 'vou/employee-repayment', '/vou/employee-repayment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-e06a081bc0551b8cf15f2ec99ae41d7e', 'menu-group-cash', 'ROUTE', 2, 170, '费用报销', NULL, true, 'vou/employee-loan-writeoff', '/vou/employee-loan-writeoff/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-2e416b3eaa9e733ca29e850c7764ea14', 'menu-group-cash', 'ROUTE', 2, 180, '费用报销', NULL, true, 'vou/expense-reimbursement', '/vou/expense-reimbursement/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-9eed327917d7837d0090dd03e7da62d2', 'menu-group-cash', 'ROUTE', 2, 190, '费用付款', NULL, true, 'vou/expense-payment', '/vou/expense-payment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-46e2fb414e61ec08d128907e14be9f07', 'menu-group-cash', 'ROUTE', 2, 200, '其他收入', NULL, true, 'vou/other-income', '/vou/other-income/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-94732e7f8e541ccb4659a2f7882c2fb8', 'menu-group-cash', 'ROUTE', 2, 210, '收票单', NULL, true, 'vou/bill-receipt', '/vou/bill-receipt/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-8aad4569e4ab78e3436174632e736844', 'menu-group-cash', 'ROUTE', 2, 220, '付票单', NULL, true, 'vou/bill-payment', '/vou/bill-payment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-c24dc9db150f6618fdb0d4c01f577b57', 'menu-group-cash', 'ROUTE', 2, 230, '开票单', NULL, true, 'vou/bill-issue', '/vou/bill-issue/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-b1075a138fc7998aa65ed2be43914c3d', 'menu-group-cash', 'ROUTE', 2, 240, '贴现单', NULL, true, 'vou/bill-discount', '/vou/bill-discount/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-2b35a2353f8a112dd87ad8feb94c74e9', 'menu-group-cash', 'ROUTE', 2, 250, '到期单', NULL, true, 'vou/bill-maturity', '/vou/bill-maturity/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-26a02d2ae86e457ca4272e3e769db547', 'menu-group-inventory', 'ROUTE', 2, 20, '产品', NULL, true, 'bob/product', '/bob/product/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-c174eba99fdd1db282a1adc74d75d620', 'menu-group-inventory', 'ROUTE', 2, 30, '库存盘点单', NULL, true, 'vou/inventory-count', '/vou/inventory-count/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-b063b36936364c050d7154e58b2e76a3', 'menu-group-inventory', 'ROUTE', 2, 40, '仓库', NULL, true, 'bob/warehouse', '/bob/warehouse/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-f7475b57bac84761b26a22da3277292f', 'menu-group-master-data', 'ROUTE', 2, 10, '客户', NULL, true, 'bob/other-party', '/bob/other-party/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-28bae55165a9e23e9539874d3370e8f4', 'menu-group-master-data', 'ROUTE', 2, 30, '车辆', NULL, true, 'bob/vehicle', '/bob/vehicle/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-c44890f4a56dc84bde58508bf7397c58', 'menu-group-master-data', 'ROUTE', 2, 40, '结算方式', NULL, true, 'bob/settlement-method', '/bob/settlement-method/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-2df6d12178ec05c0958e4d9b59f4c380', 'menu-group-people', 'ROUTE', 2, 10, '部门', NULL, true, 'aux/department', '/aux/department/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-e43c9db997eaf3074d43c20dfd8682f1', 'menu-group-people', 'ROUTE', 2, 20, '岗位', NULL, true, 'aux/position', '/aux/position/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-06f9b865ebb43f632ef0f2907cd7bd3e', 'menu-group-people', 'ROUTE', 2, 30, '员工', NULL, true, 'bob/employee', '/bob/employee/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-e3b809d6f176764b38c5579c7b980fce', 'menu-group-production', 'ROUTE', 2, 10, '生产配货', NULL, true, 'vou/order-production', '/vou/order-production/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-283d630cfe781014486003578d5f4bba', 'menu-group-production', 'ROUTE', 2, 20, '生产自制品', NULL, true, 'vou/self-production', '/vou/self-production/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-ea035e268dc22d95b9fb42f3edc6ce4a', 'menu-group-purchase', 'ROUTE', 2, 10, '供应商', NULL, true, 'bob/supplier', '/bob/supplier/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-auxiliary-data', NULL, 'GROUP', 1, 110, '辅助资料', 'mdi-shape-plus-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-2580b86c2699aa73e0c29b4c541d93b9', 'menu-group-purchase', 'ROUTE', 2, 30, '采购订单', NULL, true, 'vou/purchase-order', '/vou/purchase-order/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-5ae7560d098fe437da231a4388480103', 'menu-group-purchase', 'ROUTE', 2, 40, '采购入库', NULL, true, 'vou/purchase-inbound', '/vou/purchase-inbound/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-5bde5c0221179d8f728b22dec7ed240b', 'menu-group-purchase', 'ROUTE', 2, 50, '采购退货', NULL, true, 'vou/purchase-return', '/vou/purchase-return/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-af3fcd7b0f5db7fedfeb21cc6a647ea1', 'menu-group-sales', 'ROUTE', 2, 10, '销售定价', NULL, true, 'vou/sale-pricing', '/vou/sale-pricing/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-4e00ae3160f008c80649f3acc5a08816', 'menu-group-sales', 'ROUTE', 2, 20, '客户', NULL, true, 'bob/customer', '/bob/customer/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-364fbc57ac1c654f26bdad45e1caada3', 'menu-group-sales', 'ROUTE', 2, 30, '销售订单', NULL, true, 'vou/sale-order', '/vou/sale-order/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-246eae68e394929a5238cea20bd10252', 'menu-group-sales', 'ROUTE', 2, 40, '销售出库', NULL, true, 'vou/sale-outbound', '/vou/sale-outbound/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-977ede5554e3e881672c89e15bd27c74', 'menu-group-sales', 'ROUTE', 2, 50, '销售送货', NULL, true, 'vou/sale-delivery', '/vou/sale-delivery/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-f497df145c5212f47455ce0faf4e797c', 'menu-group-sales', 'ROUTE', 2, 60, '销售签收', NULL, true, 'vou/sale-signoff', '/vou/sale-signoff/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-79268d16803bf2e6d6bfcc8eb80b43da', 'menu-group-sales', 'ROUTE', 2, 70, '销售退货', NULL, true, 'vou/sale-return', '/vou/sale-return/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-dda278059b52a40dce6b55c9d1d0ef87', 'menu-group-workflow', 'ROUTE', 2, 10, '流程定义', NULL, true, 'wfl/process-definition', '/wfl/process-definition/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-29083391e4c37206a5992cd1029f3ac0', 'menu-group-workflow', 'ROUTE', 2, 20, '流程实例', NULL, true, 'wfl/process-instance', '/wfl/process-instance/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-40067b25c0252ec39b4a61276c901356', 'menu-group-workflow', 'ROUTE', 2, 30, '采购履约', NULL, true, 'wfl/purchase-fulfillment', '/wfl/purchase-fulfillment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-1c360ef793abacef49b1b8e45e3112e3', 'menu-group-workflow', 'ROUTE', 2, 40, '销售履约流程', NULL, true, 'wfl/sales-fulfillment', '/wfl/sales-fulfillment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-admin-user', 'menu-group-system', 'ROUTE', 2, 10, '用户管理', 'mdi-account-multiple-outline', true, 'app/user', '/app/user/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-admin-role', 'menu-group-system', 'ROUTE', 2, 20, '角色管理', 'mdi-account-key-outline', true, 'app/role', '/app/role/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-admin-permission', 'menu-group-system', 'ROUTE', 2, 30, '权限管理', 'mdi-shield-key-outline', true, 'app/permission', '/app/permission/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-admin-system-parameter', 'menu-group-system', 'ROUTE', 2, 40, '系统参数', 'mdi-tune-variant', true, 'app/system-parameter', '/app/system-parameter/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-admin-menu', 'menu-group-system', 'ROUTE', 2, 50, '菜单管理', 'mdi-menu-open', true, 'app/menu', '/app/menu/save-business-template', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-intermediary-calculation', 'menu-group-sales', 'ROUTE', 2, 45, '居间计算', 'mdi-calculator-variant-outline', true, 'vou/intermediary-calculation', '/vou/intermediary-calculation/query', 2, '2026-08-24 15:23:49.721747+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-9f7106bd7e66737f49e5f3abcc1db570', 'menu-group-cash', 'ROUTE', 2, 90, '销售收款', NULL, true, 'vou/sales-receipt', '/vou/sales-receipt/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-90cd420c3357040e3241d9d4cdf572a0', 'menu-group-cash', 'ROUTE', 2, 100, '采购退款', NULL, true, 'vou/purchase-refund', '/vou/purchase-refund/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-2abc1ef29702ea9b7ba09fb3fb5ad459', 'menu-group-cash', 'ROUTE', 2, 120, '销售退款', NULL, true, 'vou/sales-refund', '/vou/sales-refund/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('route-90c42bf9aa34fd47e542224fba1c9099', 'menu-group-cash', 'ROUTE', 2, 130, '采购付款', NULL, true, 'vou/purchase-payment', '/vou/purchase-payment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-workbench-direct-0', NULL, 'ROUTE', 1, 10, '工作台', 'mdi-view-dashboard-outline', true, 'home/dashboard', '/app/workbench/query', 2, '2026-08-24 15:23:49.976769+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-sales', NULL, 'GROUP', 1, 20, '销售', 'mdi-cart-arrow-up', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-purchase', NULL, 'GROUP', 1, 30, '采购', 'mdi-cart-arrow-down', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-production', NULL, 'GROUP', 1, 40, '生产', 'mdi-factory', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-inventory', NULL, 'GROUP', 1, 50, '库存', 'mdi-warehouse', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-cash', NULL, 'GROUP', 1, 60, '出纳', 'mdi-cash-register', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-assets', NULL, 'GROUP', 1, 70, '资产', 'mdi-office-building-cog-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-people', NULL, 'GROUP', 1, 80, '人事', 'mdi-account-group-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-accounting', NULL, 'GROUP', 1, 90, '会计', 'mdi-calculator-variant-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-workflow', NULL, 'GROUP', 1, 120, '业务流程', 'mdi-transit-connection-variant', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-system', NULL, 'GROUP', 1, 130, '系统管理', 'mdi-cog-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-3bd625b1e4fab7df6ca50ededc2b5db4', 'menu-group-cash', 'ROUTE', 2, 80, '资金账户', NULL, true, 'bob/fund-account', '/bob/fund-account/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-f5250d63a2a164f7ab3703650939dae5', 'menu-group-cash', 'ROUTE', 2, 110, '往来收款', NULL, true, 'vou/other-receipt', '/vou/other-receipt/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-cf1ab6d8cbdc6e4beee674f9ba74331a', 'menu-group-cash', 'ROUTE', 2, 140, '往来付款', NULL, true, 'vou/other-payment', '/vou/other-payment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-ed48b9ae73d1aae5d62dd030697d2d60', 'menu-group-cash', 'ROUTE', 2, 150, '往来付款', NULL, true, 'vou/employee-loan', '/vou/employee-loan/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-group-other', NULL, 'GROUP', 1, 140, '其他/待归类', 'mdi-folder-question-outline', true, NULL, NULL, 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-5edfba69a6100b8246936882a6e6a1d1', 'menu-group-assets', 'ROUTE', 2, 10, '资产类别', NULL, true, 'aux/asset-category', '/aux/asset-category/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-5621c6b304b4ec1972f3d7c27222b7c0', 'menu-group-assets', 'ROUTE', 2, 30, '资产购置', NULL, true, 'vou/asset-acquisition', '/vou/asset-acquisition/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-8c2412de41df776a1ef186259b3c46ed', 'menu-group-assets', 'ROUTE', 2, 50, '资产出让', NULL, true, 'vou/asset-sale', '/vou/asset-sale/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-cf273e60bdbf0735892f65eae282f163', 'menu-group-purchase', 'ROUTE', 2, 20, '采购询价', NULL, true, 'vou/purchase-inquiry', '/vou/purchase-inquiry/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-55273dfb397671aa5cfde1201e988317', 'menu-group-assets', 'ROUTE', 2, 60, '资产清算', NULL, true, 'vou/asset-liquidation', '/vou/asset-liquidation/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-7ef455e8d909e2c169bbad72746120d3', 'menu-group-auxiliary-data', 'ROUTE', 2, 10, '产品分类', NULL, true, 'aux/product-category', '/aux/product-category/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-210f05f5c6eba36e5c3a1085fd060a0b', 'menu-group-auxiliary-data', 'ROUTE', 2, 20, '产品类型', NULL, true, 'aux/product-type', '/aux/product-type/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-ee125d1adcda16c0f5e7dce3a1b29c15', 'menu-group-auxiliary-data', 'ROUTE', 2, 30, '计量单位', NULL, true, 'aux/measurement-unit', '/aux/measurement-unit/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-7b6b7779632846a5bd990848e5fb1e88', 'menu-group-auxiliary-data', 'ROUTE', 2, 40, '字典类型', NULL, true, 'aux/dictionary-type', '/aux/dictionary-type/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-529365f0788ee2f5849d2bccf82a5e11', 'menu-group-auxiliary-data', 'ROUTE', 2, 50, '字典项', NULL, true, 'aux/dictionary-item', '/aux/dictionary-item/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-ab6bba0d23a92d0d1c3d4d74ff86c3ae', 'menu-group-auxiliary-data', 'ROUTE', 2, 60, '收支类型', NULL, true, 'aux/income-expense-type', '/aux/income-expense-type/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-3e2ff8ddac4aa25630156b745c869757', 'menu-group-cash', 'ROUTE', 2, 160, '往来收款', NULL, true, 'vou/employee-repayment', '/vou/employee-repayment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-e06a081bc0551b8cf15f2ec99ae41d7e', 'menu-group-cash', 'ROUTE', 2, 170, '费用报销', NULL, true, 'vou/employee-loan-writeoff', '/vou/employee-loan-writeoff/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-2e416b3eaa9e733ca29e850c7764ea14', 'menu-group-cash', 'ROUTE', 2, 180, '费用报销', NULL, true, 'vou/expense-reimbursement', '/vou/expense-reimbursement/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-9eed327917d7837d0090dd03e7da62d2', 'menu-group-cash', 'ROUTE', 2, 190, '费用付款', NULL, true, 'vou/expense-payment', '/vou/expense-payment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-46e2fb414e61ec08d128907e14be9f07', 'menu-group-cash', 'ROUTE', 2, 200, '其他收入', NULL, true, 'vou/other-income', '/vou/other-income/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-94732e7f8e541ccb4659a2f7882c2fb8', 'menu-group-cash', 'ROUTE', 2, 210, '收票单', NULL, true, 'vou/bill-receipt', '/vou/bill-receipt/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-8aad4569e4ab78e3436174632e736844', 'menu-group-cash', 'ROUTE', 2, 220, '付票单', NULL, true, 'vou/bill-payment', '/vou/bill-payment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-c24dc9db150f6618fdb0d4c01f577b57', 'menu-group-cash', 'ROUTE', 2, 230, '开票单', NULL, true, 'vou/bill-issue', '/vou/bill-issue/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-b1075a138fc7998aa65ed2be43914c3d', 'menu-group-cash', 'ROUTE', 2, 240, '贴现单', NULL, true, 'vou/bill-discount', '/vou/bill-discount/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-2b35a2353f8a112dd87ad8feb94c74e9', 'menu-group-cash', 'ROUTE', 2, 250, '到期单', NULL, true, 'vou/bill-maturity', '/vou/bill-maturity/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-26a02d2ae86e457ca4272e3e769db547', 'menu-group-inventory', 'ROUTE', 2, 20, '产品', NULL, true, 'bob/product', '/bob/product/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-c174eba99fdd1db282a1adc74d75d620', 'menu-group-inventory', 'ROUTE', 2, 30, '库存盘点单', NULL, true, 'vou/inventory-count', '/vou/inventory-count/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-b063b36936364c050d7154e58b2e76a3', 'menu-group-inventory', 'ROUTE', 2, 40, '仓库', NULL, true, 'bob/warehouse', '/bob/warehouse/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-f7475b57bac84761b26a22da3277292f', 'menu-group-master-data', 'ROUTE', 2, 10, '客户', NULL, true, 'bob/other-party', '/bob/other-party/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-28bae55165a9e23e9539874d3370e8f4', 'menu-group-master-data', 'ROUTE', 2, 30, '车辆', NULL, true, 'bob/vehicle', '/bob/vehicle/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-c44890f4a56dc84bde58508bf7397c58', 'menu-group-master-data', 'ROUTE', 2, 40, '结算方式', NULL, true, 'bob/settlement-method', '/bob/settlement-method/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-2df6d12178ec05c0958e4d9b59f4c380', 'menu-group-people', 'ROUTE', 2, 10, '部门', NULL, true, 'aux/department', '/aux/department/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-e43c9db997eaf3074d43c20dfd8682f1', 'menu-group-people', 'ROUTE', 2, 20, '岗位', NULL, true, 'aux/position', '/aux/position/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-06f9b865ebb43f632ef0f2907cd7bd3e', 'menu-group-people', 'ROUTE', 2, 30, '员工', NULL, true, 'bob/employee', '/bob/employee/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-e3b809d6f176764b38c5579c7b980fce', 'menu-group-production', 'ROUTE', 2, 10, '生产配货', NULL, true, 'vou/order-production', '/vou/order-production/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-283d630cfe781014486003578d5f4bba', 'menu-group-production', 'ROUTE', 2, 20, '生产自制品', NULL, true, 'vou/self-production', '/vou/self-production/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-ea035e268dc22d95b9fb42f3edc6ce4a', 'menu-group-purchase', 'ROUTE', 2, 10, '供应商', NULL, true, 'bob/supplier', '/bob/supplier/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-2580b86c2699aa73e0c29b4c541d93b9', 'menu-group-purchase', 'ROUTE', 2, 30, '采购订单', NULL, true, 'vou/purchase-order', '/vou/purchase-order/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-5ae7560d098fe437da231a4388480103', 'menu-group-purchase', 'ROUTE', 2, 40, '采购入库', NULL, true, 'vou/purchase-inbound', '/vou/purchase-inbound/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-5bde5c0221179d8f728b22dec7ed240b', 'menu-group-purchase', 'ROUTE', 2, 50, '采购退货', NULL, true, 'vou/purchase-return', '/vou/purchase-return/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-af3fcd7b0f5db7fedfeb21cc6a647ea1', 'menu-group-sales', 'ROUTE', 2, 10, '销售定价', NULL, true, 'vou/sale-pricing', '/vou/sale-pricing/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-4e00ae3160f008c80649f3acc5a08816', 'menu-group-sales', 'ROUTE', 2, 20, '客户', NULL, true, 'bob/customer', '/bob/customer/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-364fbc57ac1c654f26bdad45e1caada3', 'menu-group-sales', 'ROUTE', 2, 30, '销售订单', NULL, true, 'vou/sale-order', '/vou/sale-order/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-246eae68e394929a5238cea20bd10252', 'menu-group-sales', 'ROUTE', 2, 40, '销售出库', NULL, true, 'vou/sale-outbound', '/vou/sale-outbound/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-977ede5554e3e881672c89e15bd27c74', 'menu-group-sales', 'ROUTE', 2, 50, '销售送货', NULL, true, 'vou/sale-delivery', '/vou/sale-delivery/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-f497df145c5212f47455ce0faf4e797c', 'menu-group-sales', 'ROUTE', 2, 60, '销售签收', NULL, true, 'vou/sale-signoff', '/vou/sale-signoff/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-79268d16803bf2e6d6bfcc8eb80b43da', 'menu-group-sales', 'ROUTE', 2, 70, '销售退货', NULL, true, 'vou/sale-return', '/vou/sale-return/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-dda278059b52a40dce6b55c9d1d0ef87', 'menu-group-workflow', 'ROUTE', 2, 10, '流程定义', NULL, true, 'wfl/process-definition', '/wfl/process-definition/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-29083391e4c37206a5992cd1029f3ac0', 'menu-group-workflow', 'ROUTE', 2, 20, '流程实例', NULL, true, 'wfl/process-instance', '/wfl/process-instance/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-40067b25c0252ec39b4a61276c901356', 'menu-group-workflow', 'ROUTE', 2, 30, '采购履约', NULL, true, 'wfl/purchase-fulfillment', '/wfl/purchase-fulfillment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-1c360ef793abacef49b1b8e45e3112e3', 'menu-group-workflow', 'ROUTE', 2, 40, '销售履约流程', NULL, true, 'wfl/sales-fulfillment', '/wfl/sales-fulfillment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-admin-user', 'menu-group-system', 'ROUTE', 2, 10, '用户管理', 'mdi-account-multiple-outline', true, 'app/user', '/app/user/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-admin-role', 'menu-group-system', 'ROUTE', 2, 20, '角色管理', 'mdi-account-key-outline', true, 'app/role', '/app/role/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-admin-permission', 'menu-group-system', 'ROUTE', 2, 30, '权限管理', 'mdi-shield-key-outline', true, 'app/permission', '/app/permission/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-admin-system-parameter', 'menu-group-system', 'ROUTE', 2, 40, '系统参数', 'mdi-tune-variant', true, 'app/system-parameter', '/app/system-parameter/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-admin-menu', 'menu-group-system', 'ROUTE', 2, 50, '菜单管理', 'mdi-menu-open', true, 'app/menu', '/app/menu/save-business-template', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-intermediary-calculation', 'menu-group-sales', 'ROUTE', 2, 45, '居间计算', 'mdi-calculator-variant-outline', true, 'vou/intermediary-calculation', '/vou/intermediary-calculation/query', 2, '2026-08-24 15:23:49.721747+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-9f7106bd7e66737f49e5f3abcc1db570', 'menu-group-cash', 'ROUTE', 2, 90, '销售收款', NULL, true, 'vou/sales-receipt', '/vou/sales-receipt/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-90cd420c3357040e3241d9d4cdf572a0', 'menu-group-cash', 'ROUTE', 2, 100, '采购退款', NULL, true, 'vou/purchase-refund', '/vou/purchase-refund/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-2abc1ef29702ea9b7ba09fb3fb5ad459', 'menu-group-cash', 'ROUTE', 2, 120, '销售退款', NULL, true, 'vou/sales-refund', '/vou/sales-refund/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('route-90c42bf9aa34fd47e542224fba1c9099', 'menu-group-cash', 'ROUTE', 2, 130, '采购付款', NULL, true, 'vou/purchase-payment', '/vou/purchase-payment/query', 2, '2026-08-24 15:23:49.677744+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-workbench-direct-0', NULL, 'ROUTE', 1, 10, '工作台', 'mdi-view-dashboard-outline', true, 'home/dashboard', '/app/workbench/query', 2, '2026-08-24 15:23:49.976769+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.139562+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-aux-product-type', 'menu-group-auxiliary-data', 'ROUTE', 2, 15, '产品类型', 'mdi-shape-outline', true, 'aux/product-type', '/aux/product-type/query', 2, '2026-08-24 15:23:50.674482+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.674482+00', '01JAPPSYST3MACTR0000000000', 'DRAFT');
INSERT INTO public.app_business_menu_items VALUES ('menu-route-aux-product-type', 'menu-group-auxiliary-data', 'ROUTE', 2, 15, '产品类型', 'mdi-shape-outline', true, 'aux/product-type', '/aux/product-type/query', 2, '2026-08-24 15:23:50.674482+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:50.674482+00', '01JAPPSYST3MACTR0000000000', 'PUBLISHED');
...
--
-- Data for Name: app_feedback_attachments; Type: TABLE DATA; Schema: public; Owner: -
--



--
-- Data for Name: app_feedback_files; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.app_permissions VALUES ('01JAPP00000000000000000016', '/app/user/profile', 'app', 'user', 'profile', '查看当前用户资料', 'ENABLED', '2026-08-24 15:23:48.910646+00', NULL, '2026-08-24 15:23:48.910646+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JAPPMENU0000000000000001', '/app/menu/save-business-template', 'app', 'menu', 'save-business-template', '保存业务菜单模板', 'ENABLED', '2026-08-24 15:23:49.677744+00', NULL, '2026-08-24 15:23:49.677744+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JAPPMENU0000000000000003', '/app/menu/reset-business-template', 'app', 'menu', 'reset-business-template', '恢复初始业务菜单模板', 'ENABLED', '2026-08-24 15:23:49.677744+00', NULL, '2026-08-24 15:23:49.677744+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JAPPMENU0000000000000004', '/app/menu/publish-business-template', 'app', 'menu', 'publish-business-template', '发布业务菜单模板', 'ENABLED', '2026-08-24 15:23:50.139562+00', NULL, '2026-08-24 15:23:50.139562+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB83REF000000000000001', '/bob/reference/transfer', 'bob', 'reference', 'transfer', '批量转移业务对象引用', 'ENABLED', '2026-08-24 15:23:50.224888+00', NULL, '2026-08-24 15:23:50.224888+00', NULL, 1, NULL);
...
-- +goose StatementBegin
INSERT INTO public.app_system_parameters VALUES ('app.menu.mode', '当前菜单方式', '系统默认菜单或业务归类模板；只允许菜单服务修改', 'STRING', 'DEFAULT', 'DEFAULT', false, 1, '2026-08-24 15:23:49.673922+00', '01JAPPSYST3MACTR0000000000', '2026-08-24 15:23:49.673922+00', '01JAPPSYST3MACTR0000000000', true, NULL, 'IMMEDIATE', 'DEFAULT', 1, false);
...
ALTER TABLE ONLY public.app_business_menu_items
    ADD CONSTRAINT app_business_menu_items_pkey PRIMARY KEY (snapshot_type, id);


--
-- Name: app_feedback_attachments app_feedback_attachments_feedback_id_position_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.app_feedback_attachments
    ADD CONSTRAINT app_feedback_attachments_feedback_id_position_key UNIQUE (feedback_id, "position");


--
-- Name: app_feedback_attachments app_feedback_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.app_feedback_attachments
    ADD CONSTRAINT app_feedback_attachments_pkey PRIMARY KEY (feedback_id, file_id);


--
-- Name: app_feedback_files app_feedback_files_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.app_feedback_files
    ADD CONSTRAINT app_feedback_files_pkey PRIMARY KEY (id);


--
-- Name: app_feedback_files app_feedback_files_storage_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.app_feedback_files
    ADD CONSTRAINT app_feedback_files_storage_key_key UNIQUE (storage_key);


--
-- Name: app_feedback_files app_feedback_files_upload_token_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.app_feedback_files
    ADD CONSTRAINT app_feedback_files_upload_token_hash_key UNIQUE (upload_token_hash);
...
CREATE INDEX app_business_menu_items_route_key_idx ON public.app_business_menu_items USING btree (route_key) WHERE ((item_type)::text = 'ROUTE'::text);


--
-- Name: app_business_menu_items_snapshot_parent_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX app_business_menu_items_snapshot_parent_order_idx ON public.app_business_menu_items USING btree (snapshot_type, parent_id, sort_order, id);
...
CREATE UNIQUE INDEX app_business_menu_items_workbench_route_idx ON public.app_business_menu_items USING btree (snapshot_type, route_key) WHERE ((route_key)::text = 'home/dashboard'::text);


--
-- Name: app_feedback_attachment_feedback_file_uidx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX app_feedback_attachment_feedback_file_uidx ON public.app_feedback_attachments USING btree (file_id) WHERE ((source)::text = 'FEEDBACK'::text);


--
-- Name: app_feedback_files_cleanup_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX app_feedback_files_cleanup_idx ON public.app_feedback_files USING btree (status, upload_expires_at, created_at, id);


--
-- Name: app_feedback_files_creator_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX app_feedback_files_creator_idx ON public.app_feedback_files USING btree (created_by, created_at DESC, id DESC);


--
-- Name: app_feedback_owner_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX app_feedback_owner_idx ON public.app_feedback USING btree (user_id, created_at DESC, id DESC);


--
-- Name: app_feedback_publish_queue_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX app_feedback_publish_queue_idx ON public.app_feedback USING btree (next_attempt_at, created_at, id) WHERE ((status)::text = ANY ((ARRAY['PENDING'::character varying, 'PROCESSING'::character varying])::text[]));
...
ALTER TABLE ONLY public.app_business_menu_items
    ADD CONSTRAINT app_business_menu_items_parent_fk FOREIGN KEY (snapshot_type, parent_id) REFERENCES public.app_business_menu_items(snapshot_type, id) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: app_feedback_attachments app_feedback_attachments_feedback_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.app_feedback_attachments
    ADD CONSTRAINT app_feedback_attachments_feedback_id_fkey FOREIGN KEY (feedback_id) REFERENCES public.app_feedback(id) ON DELETE CASCADE;


--
-- Name: app_feedback_files app_feedback_files_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.app_feedback_files
    ADD CONSTRAINT app_feedback_files_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.app_users(id) ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.app_feedback
    ADD CONSTRAINT app_feedback_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.app_users(id) ON DELETE RESTRICT;
