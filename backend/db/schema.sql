...
CREATE TABLE public.dcl_employee_versions (
    ...
    hire_date date,
    current_operating_entity_id character varying(26) NOT NULL,
    current_operating_entity_approval_entry_id character varying(26) NOT NULL,
    current_operating_entity_code character varying(64) NOT NULL,
    current_operating_entity_name character varying(200) NOT NULL,
    remark character varying(1000),
    enabled boolean NOT NULL,
    CONSTRAINT dcl_employee_versions_pkey PRIMARY KEY (approval_entry_id),
    CONSTRAINT dcl_employee_versions_kind_ck CHECK (kind IN ('PERSON','ORGANIZATION')),
    CONSTRAINT dcl_employee_versions_legal_name_ck CHECK (length(btrim(legal_name)) BETWEEN 1 AND 200),
    CONSTRAINT dcl_employee_versions_display_name_ck CHECK (length(btrim(display_name)) BETWEEN 1 AND 200),
...
CREATE TABLE public.dcl_other_unit_versions (
    ...
    default_operating_entity_id character varying(26) NOT NULL,
    default_operating_entity_approval_entry_id character varying(26) NOT NULL,
    default_operating_entity_code character varying(64) NOT NULL,
    default_operating_entity_name character varying(200) NOT NULL,
    remark character varying(1000),
    enabled boolean NOT NULL,
    CONSTRAINT dcl_other_unit_versions_pkey PRIMARY KEY (approval_entry_id),
    CONSTRAINT dcl_other_unit_versions_kind_ck CHECK (kind IN ('PERSON','ORGANIZATION')),
    CONSTRAINT dcl_other_unit_versions_legal_name_ck CHECK (length(btrim(legal_name)) BETWEEN 1 AND 200),
    CONSTRAINT dcl_other_unit_versions_display_name_ck CHECK (length(btrim(display_name)) BETWEEN 1 AND 200),
...
CREATE TABLE public.dcl_sales_partner_versions (
    ...
    CONSTRAINT dcl_sales_partner_versions_kind_ck CHECK (kind IN ('PERSON','ORGANIZATION')),
    CONSTRAINT dcl_sales_partner_versions_legal_name_ck CHECK (length(btrim(legal_name)) BETWEEN 1 AND 200),
    CONSTRAINT dcl_sales_partner_versions_display_name_ck CHECK (length(btrim(display_name)) BETWEEN 1 AND 200),
...
CREATE TABLE public.dcl_supplier_versions (
    ...
    CONSTRAINT dcl_supplier_versions_kind_ck CHECK (kind IN ('PERSON','ORGANIZATION')),
    CONSTRAINT dcl_supplier_versions_legal_name_ck CHECK (length(btrim(legal_name)) BETWEEN 1 AND 200),
    CONSTRAINT dcl_supplier_versions_display_name_ck CHECK (length(btrim(display_name)) BETWEEN 1 AND 200),
...
CREATE TABLE public.dcl_supplier_version_operating_entities (
    ...
    CONSTRAINT dcl_supplier_version_operating_entities_pkey PRIMARY KEY (approval_entry_id, operating_entity_id)
);
CREATE TABLE public.dcl_other_unit_version_operating_entities (
    approval_entry_id character varying(26) NOT NULL, operating_entity_id character varying(26) NOT NULL,
    operating_entity_approval_entry_id character varying(26) NOT NULL, operating_entity_code character varying(64) NOT NULL, operating_entity_name character varying(200) NOT NULL,
    CONSTRAINT dcl_other_unit_version_operating_entities_pkey PRIMARY KEY (approval_entry_id, operating_entity_id)
);
CREATE TABLE public.dcl_sales_partner_version_operating_entities (
    approval_entry_id character varying(26) NOT NULL, operating_entity_id character varying(26) NOT NULL,
    operating_entity_approval_entry_id character varying(26) NOT NULL, operating_entity_code character varying(64) NOT NULL, operating_entity_name character varying(200) NOT NULL,
...
CREATE TABLE public.dcl_customer_version_accounts (
    ...
    CONSTRAINT dcl_customer_version_accounts_data_shape_ck CHECK (
      ...
      AND jsonb_typeof(data->'attachments')='array'
      AND jsonb_typeof(data->'customerType')='object'
      AND (NOT data ? 'settlementMethod' OR jsonb_typeof(data->'settlementMethod')='object')
      AND (NOT data ? 'paymentMethod' OR jsonb_typeof(data->'paymentMethod')='object')
    )
);
...
CREATE TABLE public.vou_receipt_details (
    ...
    counterparty_code character varying(64),
    counterparty_name character varying(200),
    customer_object_id character varying(26),
    customer_approval_entry_id character varying(26),
    customer_code character varying(64),
    customer_name character varying(200),
    operating_entity_object_id character varying(26),
    operating_entity_approval_entry_id character varying(26),
    operating_entity_code character varying(64),
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000021', '/dcl/employee/approve', 'dcl', 'employee', 'approve', '批准员工声明', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000027', '/dcl/employee/reject', 'dcl', 'employee', 'reject', '驳回员工声明', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000029', '/dcl/employee/submit', 'dcl', 'employee', 'submit', '提交员工声明', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000051', '/dcl/fund-account/approve', 'dcl', 'fund-account', 'approve', '批准资金账户', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000057', '/dcl/fund-account/reject', 'dcl', 'fund-account', 'reject', '驳回资金账户', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000059', '/dcl/fund-account/submit', 'dcl', 'fund-account', 'submit', '提交资金账户', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000031', '/dcl/product/approve', 'dcl', 'product', 'approve', '批准产品', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000037', '/dcl/product/reject', 'dcl', 'product', 'reject', '驳回产品', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000039', '/dcl/product/submit', 'dcl', 'product', 'submit', '提交产品', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000011', '/dcl/supplier/approve', 'dcl', 'supplier', 'approve', '批准供应商声明', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000017', '/dcl/supplier/reject', 'dcl', 'supplier', 'reject', '驳回供应商声明', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000019', '/dcl/supplier/submit', 'dcl', 'supplier', 'submit', '提交供应商声明', 'ENABLED', '2026-08-24 15:23:48.912973+00', NULL, '2026-08-24 15:23:48.912973+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JDCL00000000000000000293', '/dcl/customer/unapprove', 'dcl', 'customer', 'unapprove', '反批准客户声明', 'ENABLED', '2026-08-28 00:00:00+00', NULL, '2026-08-28 00:00:00+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000061', '/dcl/warehouse/approve', 'dcl', 'warehouse', 'approve', '批准仓库声明', 'ENABLED', '2026-08-24 15:23:48.940595+00', NULL, '2026-08-24 15:23:48.940595+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000067', '/dcl/warehouse/reject', 'dcl', 'warehouse', 'reject', '驳回仓库声明', 'ENABLED', '2026-08-24 15:23:48.940595+00', NULL, '2026-08-24 15:23:48.940595+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000069', '/dcl/warehouse/submit', 'dcl', 'warehouse', 'submit', '提交仓库声明', 'ENABLED', '2026-08-24 15:23:48.940595+00', NULL, '2026-08-24 15:23:48.940595+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000071', '/dcl/vehicle/approve', 'dcl', 'vehicle', 'approve', '批准车辆声明', 'ENABLED', '2026-08-24 15:23:48.948237+00', NULL, '2026-08-24 15:23:48.948237+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000077', '/dcl/vehicle/reject', 'dcl', 'vehicle', 'reject', '驳回车辆声明', 'ENABLED', '2026-08-24 15:23:48.948237+00', NULL, '2026-08-24 15:23:48.948237+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000079', '/dcl/vehicle/submit', 'dcl', 'vehicle', 'submit', '提交车辆声明', 'ENABLED', '2026-08-24 15:23:48.948237+00', NULL, '2026-08-24 15:23:48.948237+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JVOU00000000000000000006', '/vou/sale-order/unsubmit', 'vou', 'sale-order', 'unsubmit', '撤回销售订单', 'ENABLED', '2026-08-24 15:23:48.959532+00', NULL, '2026-08-24 15:23:48.959532+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01JVOU00000000000000000105', '/vou/sale-outbound/unsubmit', 'vou', 'sale-outbound', 'unsubmit', '撤回销售出库', 'ENABLED', '2026-08-24 15:23:49.226715+00', NULL, '2026-08-24 15:23:49.226715+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01JVOU00000000000000000120', '/vou/sale-delivery/unsubmit', 'vou', 'sale-delivery', 'unsubmit', '撤回销售送货', 'ENABLED', '2026-08-24 15:23:49.226715+00', NULL, '2026-08-24 15:23:49.226715+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01JVOU00000000000000000135', '/vou/sale-signoff/unsubmit', 'vou', 'sale-signoff', 'unsubmit', '撤回销售签收', 'ENABLED', '2026-08-24 15:23:49.226715+00', NULL, '2026-08-24 15:23:49.226715+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('0146FE50B2D6000DFF4272DA0E', '/vou/purchase-order/unsubmit', 'vou', 'purchase-order', 'unsubmit', '撤回采购订单', 'ENABLED', '2026-08-24 15:23:49.29388+00', NULL, '2026-08-24 15:23:49.29388+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01327AFEC8544172B16AD95C6B', '/vou/purchase-inbound/unsubmit', 'vou', 'purchase-inbound', 'unsubmit', '撤回采购入库', 'ENABLED', '2026-08-24 15:23:49.29388+00', NULL, '2026-08-24 15:23:49.29388+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01JVOU00000000000000000076', '/vou/expense-reimbursement/unsubmit', 'vou', 'expense-reimbursement', 'unsubmit', '撤回费用报销', 'ENABLED', '2026-08-24 15:23:48.959532+00', NULL, '2026-08-24 15:23:48.959532+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01JVOU00000000000000000090', '/vou/other-income/unsubmit', 'vou', 'other-income', 'unsubmit', '撤回其他收入', 'ENABLED', '2026-08-24 15:23:48.959532+00', NULL, '2026-08-24 15:23:48.959532+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('SR9c79a4eea70e976098f6a9d0', '/vou/sale-return/unsubmit', 'vou', 'sale-return', 'unsubmit', '撤回销售退货', 'ENABLED', '2026-08-24 15:23:49.390761+00', NULL, '2026-08-24 15:23:49.390761+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('PR54368ec7e5f650bc88ed7d3f', '/vou/purchase-return/unsubmit', 'vou', 'purchase-return', 'unsubmit', '撤回采购退货', 'ENABLED', '2026-08-24 15:23:49.401432+00', NULL, '2026-08-24 15:23:49.401432+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('PDf275e87ca4ea42daa9a86374', '/vou/order-production/unsubmit', 'vou', 'order-production', 'unsubmit', '撤回生产配货', 'ENABLED', '2026-08-24 15:23:49.454799+00', NULL, '2026-08-24 15:23:49.454799+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('PDb5419ac78da76c793d5d27b9', '/vou/self-production/unsubmit', 'vou', 'self-production', 'unsubmit', '撤回生产自制品', 'ENABLED', '2026-08-24 15:23:49.454799+00', NULL, '2026-08-24 15:23:49.454799+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000138', '/dcl/supplier/unapprove', 'dcl', 'supplier', 'unapprove', '反批准供应商声明', 'ENABLED', '2026-08-24 15:23:49.487716+00', NULL, '2026-08-24 15:23:49.487716+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000142', '/dcl/employee/unapprove', 'dcl', 'employee', 'unapprove', '反批准员工声明', 'ENABLED', '2026-08-24 15:23:49.487716+00', NULL, '2026-08-24 15:23:49.487716+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000145', '/dcl/product/unsubmit', 'dcl', 'product', 'unsubmit', '撤回product', 'ENABLED', '2026-08-24 15:23:49.487716+00', NULL, '2026-08-24 15:23:49.487716+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000146', '/dcl/product/unapprove', 'dcl', 'product', 'unapprove', '反批准product', 'ENABLED', '2026-08-24 15:23:49.487716+00', NULL, '2026-08-24 15:23:49.487716+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000154', '/dcl/warehouse/unapprove', 'dcl', 'warehouse', 'unapprove', '反批准仓库声明', 'ENABLED', '2026-08-24 15:23:49.487716+00', NULL, '2026-08-24 15:23:49.487716+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000158', '/dcl/vehicle/unapprove', 'dcl', 'vehicle', 'unapprove', '反批准车辆声明', 'ENABLED', '2026-08-24 15:23:49.487716+00', NULL, '2026-08-24 15:23:49.487716+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000161', '/dcl/fund-account/unsubmit', 'dcl', 'fund-account', 'unsubmit', '撤回fund-account', 'ENABLED', '2026-08-24 15:23:49.487716+00', NULL, '2026-08-24 15:23:49.487716+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01JBOB00000000000000000162', '/dcl/fund-account/unapprove', 'dcl', 'fund-account', 'unapprove', '反批准fund-account', 'ENABLED', '2026-08-24 15:23:49.487716+00', NULL, '2026-08-24 15:23:49.487716+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('PR8601392480a4956e0265e3ba', '/vou/sale-pricing/unsubmit', 'vou', 'sale-pricing', 'unsubmit', '撤回销售定价', 'ENABLED', '2026-08-24 15:23:49.505114+00', NULL, '2026-08-24 15:23:49.505114+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('PR4535924d0cb3a50f06d34cbf', '/vou/purchase-inquiry/unsubmit', 'vou', 'purchase-inquiry', 'unsubmit', '撤回采购询价', 'ENABLED', '2026-08-24 15:23:49.505114+00', NULL, '2026-08-24 15:23:49.505114+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('VE0ce3ae91a4d9c396f3dcbd98', '/vou/expense-payment/unsubmit', 'vou', 'expense-payment', 'unsubmit', '撤回费用付款', 'ENABLED', '2026-08-24 15:23:49.521804+00', NULL, '2026-08-24 15:23:49.521804+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('VE46e22b8f297e54cb85f80ae3', '/vou/expense-payment/unapprove', 'vou', 'expense-payment', 'unapprove', '反批准费用付款', 'ENABLED', '2026-08-24 15:23:49.521804+00', NULL, '2026-08-24 15:23:49.521804+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('PS824938e8f987438aa4c4830e', '/vou/other-receipt/unsubmit', 'vou', 'other-receipt', 'unsubmit', '撤回往来收款', 'ENABLED', '2026-08-24 15:23:49.547238+00', NULL, '2026-08-24 15:23:49.547238+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('PS9ed097e4c956f3ec3c6d1f43', '/vou/other-payment/unsubmit', 'vou', 'other-payment', 'unsubmit', '撤回往来付款', 'ENABLED', '2026-08-24 15:23:49.547238+00', NULL, '2026-08-24 15:23:49.547238+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('ICc983cb066a2325b2bb3b22ee', '/vou/inventory-count/unsubmit', 'vou', 'inventory-count', 'unsubmit', '撤回库存盘点单', 'ENABLED', '2026-08-24 15:23:49.566641+00', NULL, '2026-08-24 15:23:49.566641+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('PSa89b88052b70458c92abd85d', '/vou/sales-refund/unsubmit', 'vou', 'sales-refund', 'unsubmit', '撤回往来付款', 'ENABLED', '2026-08-24 15:23:49.547238+00', NULL, '2026-08-24 15:23:49.547238+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JACC00000000000000000114', '/dcl/acc-mapping/approve', 'dcl', 'acc-mapping', 'approve', '批准会计映射声明', 'ENABLED', '2026-08-24 15:23:49.791438+00', NULL, '2026-08-24 15:23:49.791438+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01JACC00000000000000000115', '/dcl/acc-mapping/unapprove', 'dcl', 'acc-mapping', 'unapprove', '反批准会计映射声明', 'ENABLED', '2026-08-24 15:23:49.791438+00', NULL, '2026-08-24 15:23:49.791438+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JACC00000000000000000213', '/dcl/acc-mapping/submit', 'dcl', 'acc-mapping', 'submit', '提交会计映射声明', 'ENABLED', '2026-08-24 15:23:49.791438+00', NULL, '2026-08-24 15:23:49.791438+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JACC00000000000000000215', '/dcl/acc-mapping/reject', 'dcl', 'acc-mapping', 'reject', '驳回会计映射声明', 'ENABLED', '2026-08-24 15:23:49.791438+00', NULL, '2026-08-24 15:23:49.791438+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01KRPT00000000000000000006', '/dcl/rpt-definition/approve', 'dcl', 'rpt-definition', 'approve', '批准报表定义声明', 'ENABLED', '2026-08-24 15:23:49.887333+00', NULL, '2026-08-29 00:00:00+00', NULL, 2, NULL);
INSERT INTO public.app_permissions VALUES ('01KRPT00000000000000000007', '/dcl/rpt-definition/unapprove', 'dcl', 'rpt-definition', 'unapprove', '反批准报表定义声明', 'ENABLED', '2026-08-24 15:23:49.887333+00', NULL, '2026-08-29 00:00:00+00', NULL, 2, NULL);
...
INSERT INTO public.app_permissions VALUES ('01KRPT00000000000000000012', '/dcl/rpt-definition/submit', 'dcl', 'rpt-definition', 'submit', '提交报表定义声明', 'ENABLED', '2026-08-24 15:23:49.887333+00', NULL, '2026-08-29 00:00:00+00', NULL, 2, NULL);
...
INSERT INTO public.app_permissions VALUES ('01KRPT00000000000000000014', '/dcl/rpt-definition/reject', 'dcl', 'rpt-definition', 'reject', '驳回报表定义声明', 'ENABLED', '2026-08-24 15:23:49.887333+00', NULL, '2026-08-29 00:00:00+00', NULL, 2, NULL);
...
INSERT INTO public.app_permissions VALUES ('01KWFL00000000000000000012', '/dcl/wfl-process-definition/submit', 'dcl', 'wfl-process-definition', 'submit', '提交流程定义声明', 'ENABLED', '2026-08-29 00:00:00+00', NULL, '2026-08-29 00:00:00+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01KWFL00000000000000000014', '/dcl/wfl-process-definition/reject', 'dcl', 'wfl-process-definition', 'reject', '驳回流程定义声明', 'ENABLED', '2026-08-29 00:00:00+00', NULL, '2026-08-29 00:00:00+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01KWFL00000000000000000015', '/dcl/wfl-process-definition/approve', 'dcl', 'wfl-process-definition', 'approve', '批准流程定义声明', 'ENABLED', '2026-08-29 00:00:00+00', NULL, '2026-08-29 00:00:00+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01KWFL00000000000000000016', '/dcl/wfl-process-definition/unapprove', 'dcl', 'wfl-process-definition', 'unapprove', '反批准流程定义声明', 'ENABLED', '2026-08-29 00:00:00+00', NULL, '2026-08-29 00:00:00+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('FV889700557551578b0e85298d', '/vou/asset-acquisition/unsubmit', 'vou', 'asset-acquisition', 'unsubmit', '撤回资产购置', 'ENABLED', '2026-08-24 15:23:49.574507+00', NULL, '2026-08-24 15:23:49.574507+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('FV19418a9c9c0456d39e544c25', '/vou/asset-sale/unsubmit', 'vou', 'asset-sale', 'unsubmit', '撤回资产出让', 'ENABLED', '2026-08-24 15:23:49.574507+00', NULL, '2026-08-24 15:23:49.574507+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('FV76646cfc58ea0e2a420f1915', '/vou/asset-liquidation/unsubmit', 'vou', 'asset-liquidation', 'unsubmit', '撤回资产清算', 'ENABLED', '2026-08-24 15:23:49.574507+00', NULL, '2026-08-24 15:23:49.574507+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('FVc48487fea4d87228be34588f', '/vou/asset-acquisition/unapprove', 'vou', 'asset-acquisition', 'unapprove', '反批准资产购置', 'ENABLED', '2026-08-24 15:23:49.574507+00', NULL, '2026-08-24 15:23:49.574507+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('FV949cdce411f508889c872e4f', '/vou/asset-sale/unapprove', 'vou', 'asset-sale', 'unapprove', '反批准资产出让', 'ENABLED', '2026-08-24 15:23:49.574507+00', NULL, '2026-08-24 15:23:49.574507+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('FVa9ea59188357248ab15505e0', '/vou/asset-liquidation/unapprove', 'vou', 'asset-liquidation', 'unapprove', '反批准资产清算', 'ENABLED', '2026-08-24 15:23:49.574507+00', NULL, '2026-08-24 15:23:49.574507+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('PS3c3ae981eb3942ec66ac1930', '/vou/employee-loan-writeoff/unsubmit', 'vou', 'employee-loan-writeoff', 'unsubmit', '撤回费用报销', 'ENABLED', '2026-08-24 15:23:49.601051+00', NULL, '2026-08-24 15:23:49.601051+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('PSeaa9fba996ceeae8c43bf015', '/vou/employee-repayment/unsubmit', 'vou', 'employee-repayment', 'unsubmit', '撤回往来收款', 'ENABLED', '2026-08-24 15:23:49.601051+00', NULL, '2026-08-24 15:23:49.601051+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('PS240f04218506a963b79b45b6', '/vou/employee-loan/unsubmit', 'vou', 'employee-loan', 'unsubmit', '撤回往来付款', 'ENABLED', '2026-08-24 15:23:49.601051+00', NULL, '2026-08-24 15:23:49.601051+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('BIL20085cedb2039b2d52c1e4c', '/vou/bill-receipt/unsubmit', 'vou', 'bill-receipt', 'unsubmit', '撤回收票单', 'ENABLED', '2026-08-24 15:23:49.649049+00', NULL, '2026-08-24 15:23:49.649049+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('BLP84a2abb53e594631c66ecda', '/vou/bill-payment/unsubmit', 'vou', 'bill-payment', 'unsubmit', '撤回付票单', 'ENABLED', '2026-08-24 15:23:49.666178+00', NULL, '2026-08-24 15:23:49.666178+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('BLI058489be49de1c40c29b77e', '/vou/bill-issue/unsubmit', 'vou', 'bill-issue', 'unsubmit', '撤回开票单', 'ENABLED', '2026-08-24 15:23:49.668473+00', NULL, '2026-08-24 15:23:49.668473+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('BLDf426f96ed1bacbefdb4ae7d', '/vou/bill-discount/unsubmit', 'vou', 'bill-discount', 'unsubmit', '撤回贴现单', 'ENABLED', '2026-08-24 15:23:49.670459+00', NULL, '2026-08-24 15:23:49.670459+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('BLMdd19830965bb179e21139ce', '/vou/bill-maturity/unsubmit', 'vou', 'bill-maturity', 'unsubmit', '撤回到期单', 'ENABLED', '2026-08-24 15:23:49.672191+00', NULL, '2026-08-24 15:23:49.672191+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('ICL42cbb05a7d25bbeb4669a01', '/vou/intermediary-calculation/unsubmit', 'vou', 'intermediary-calculation', 'unsubmit', '撤回居间计算', 'ENABLED', '2026-08-24 15:23:49.702898+00', NULL, '2026-08-24 15:23:49.702898+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('PS4222795453181f926b5e09d4', '/vou/purchase-refund/unsubmit', 'vou', 'purchase-refund', 'unsubmit', '撤回往来收款', 'ENABLED', '2026-08-24 15:23:49.547238+00', NULL, '2026-08-24 15:23:49.547238+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('PS691e162c5e052efeff772258', '/vou/sales-receipt/unsubmit', 'vou', 'sales-receipt', 'unsubmit', '撤回往来收款', 'ENABLED', '2026-08-24 15:23:49.547238+00', NULL, '2026-08-24 15:23:49.547238+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('PS6db352d644573dae90511096', '/vou/purchase-payment/unsubmit', 'vou', 'purchase-payment', 'unsubmit', '撤回往来付款', 'ENABLED', '2026-08-24 15:23:49.547238+00', NULL, '2026-08-24 15:23:49.547238+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB83000000000000000001', '/dcl/operating-entity/approve', 'dcl', 'operating-entity', 'approve', '批准经营主体', 'ENABLED', '2026-08-24 15:23:50.224888+00', NULL, '2026-08-24 15:23:50.224888+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB85000000000000000013', '/dcl/other-unit/approve', 'dcl', 'other-unit', 'approve', '批准其他单位', 'ENABLED', '2026-08-24 15:23:50.307347+00', NULL, '2026-08-24 15:23:50.307347+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JBOB86SLP000000000000008', '/dcl/sales-partner/approve', 'dcl', 'sales-partner', 'approve', '批准销售合作方', 'ENABLED', '2026-08-24 15:23:50.347482+00', NULL, '2026-08-24 15:23:50.347482+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JVOU87000000000000000006', '/vou/service-contract/unsubmit', 'vou', 'service-contract', 'unsubmit', '撤回服务合同', 'ENABLED', '2026-08-24 15:23:50.387239+00', NULL, '2026-08-24 15:23:50.387239+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JVOU87000000000000000016', '/vou/service-acceptance/unsubmit', 'vou', 'service-acceptance', 'unsubmit', '撤回履约验收', 'ENABLED', '2026-08-24 15:23:50.387239+00', NULL, '2026-08-24 15:23:50.387239+00', NULL, 1, NULL);
...
INSERT INTO public.app_permissions VALUES ('01JPR3BOB00000000000000002', '/dcl/other-unit/unapprove', 'dcl', 'other-unit', 'unapprove', '反批准其他单位', 'ENABLED', '2026-08-24 15:23:50.451904+00', NULL, '2026-08-24 15:23:50.451904+00', NULL, 1, NULL);
INSERT INTO public.app_permissions VALUES ('01JPR3BOB00000000000000003', '/dcl/sales-partner/unapprove', 'dcl', 'sales-partner', 'unapprove', '反批准销售合作关系', 'ENABLED', '2026-08-24 15:23:50.451904+00', NULL, '2026-08-24 15:23:50.451904+00', NULL, 1, NULL);
...
ALTER TABLE ONLY public.dcl_employee_versions
    ADD CONSTRAINT dcl_employee_versions_current_operating_entity_id_fkey
    FOREIGN KEY (current_operating_entity_id) REFERENCES public.dcl_subjects(id) ON DELETE RESTRICT;
ALTER TABLE ONLY public.dcl_employee_versions
    ADD CONSTRAINT dcl_employee_versions_current_operating_entry_id_fkey
    FOREIGN KEY (current_operating_entity_approval_entry_id) REFERENCES public.approval_entries(id) ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.dcl_other_unit_versions
    ADD CONSTRAINT dcl_other_unit_versions_default_operating_entity_id_fkey
    FOREIGN KEY (default_operating_entity_id) REFERENCES public.dcl_subjects(id) ON DELETE RESTRICT;
ALTER TABLE ONLY public.dcl_other_unit_versions
    ADD CONSTRAINT dcl_other_unit_versions_default_operating_entry_id_fkey
...
ALTER TABLE ONLY public.dcl_supplier_versions
    ADD CONSTRAINT dcl_supplier_versions_default_operating_entity_id_fkey
    FOREIGN KEY (default_operating_entity_id) REFERENCES public.dcl_subjects(id) ON DELETE RESTRICT;
ALTER TABLE ONLY public.dcl_supplier_versions
    ADD CONSTRAINT dcl_supplier_versions_default_operating_entry_id_fkey
    FOREIGN KEY (default_operating_entity_approval_entry_id) REFERENCES public.approval_entries(id) ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.dcl_sales_partner_versions
    ...
    FOREIGN KEY (approval_entry_id) REFERENCES public.approval_entries(id) ON DELETE RESTRICT;
ALTER TABLE ONLY public.dcl_sales_partner_versions
    ADD CONSTRAINT dcl_sales_partner_versions_default_operating_entity_id_fkey
    FOREIGN KEY (default_operating_entity_id) REFERENCES public.dcl_subjects(id) ON DELETE RESTRICT;
ALTER TABLE ONLY public.dcl_sales_partner_versions
...
ALTER TABLE ONLY public.dcl_other_unit_version_operating_entities
    ADD CONSTRAINT dcl_other_unit_version_operating_entities_entry_fkey FOREIGN KEY (approval_entry_id) REFERENCES public.dcl_other_unit_versions(approval_entry_id) ON DELETE CASCADE;
ALTER TABLE ONLY public.dcl_sales_partner_version_operating_entities
    ADD CONSTRAINT dcl_sales_partner_version_operating_entities_entry_fkey FOREIGN KEY (approval_entry_id) REFERENCES public.dcl_sales_partner_versions(approval_entry_id) ON DELETE CASCADE;
ALTER TABLE ONLY public.dcl_supplier_version_operating_entities
    ADD CONSTRAINT dcl_supplier_version_operating_entities_operating_entry_fkey FOREIGN KEY (operating_entity_approval_entry_id) REFERENCES public.approval_entries(id) ON DELETE RESTRICT;
ALTER TABLE ONLY public.dcl_other_unit_version_operating_entities
    ADD CONSTRAINT dcl_other_unit_version_operating_entities_operating_entry_fkey FOREIGN KEY (operating_entity_approval_entry_id) REFERENCES public.approval_entries(id) ON DELETE RESTRICT;
ALTER TABLE ONLY public.dcl_sales_partner_version_operating_entities
    ADD CONSTRAINT dcl_sales_partner_version_operating_entities_operating_entry_fkey FOREIGN KEY (operating_entity_approval_entry_id) REFERENCES public.approval_entries(id) ON DELETE RESTRICT;
ALTER TABLE ONLY public.dcl_supplier_version_operating_entities
    ADD CONSTRAINT dcl_supplier_version_operating_entities_operating_subject_fkey FOREIGN KEY (operating_entity_id) REFERENCES public.dcl_subjects(id) ON DELETE RESTRICT;
ALTER TABLE ONLY public.dcl_other_unit_version_operating_entities
