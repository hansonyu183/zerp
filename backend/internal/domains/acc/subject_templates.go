...
var enterpriseSubjectTemplate = []subjectTemplateLine{
	...
	{Code: "1123", Name: "预付账款", ParentCode: "1000", BalanceDirection: BalanceDirectionDebit, Dimensions: []string{DimensionSupplierRelationship}, SettlementPurpose: SettlementPurposePrepaid},
	{Code: "1221", Name: "其他应收款", ParentCode: "1000", BalanceDirection: BalanceDirectionDebit, SettlementPurpose: SettlementPurposeNone},
	{Code: "122101", Name: "员工借款", ParentCode: "1221", BalanceDirection: BalanceDirectionDebit, Dimensions: []string{DimensionEmploymentRelationship}, SettlementPurpose: SettlementPurposeOther},
	{Code: "122102", Name: "服务往来", ParentCode: "1221", BalanceDirection: BalanceDirectionDebit, Dimensions: []string{DimensionServiceRelationship}, SettlementPurpose: SettlementPurposeOther},
	...
	{Code: "2201", Name: "应付票据", ParentCode: "2000", BalanceDirection: BalanceDirectionCredit, Dimensions: []string{DimensionSupplierRelationship, DimensionBill}, SettlementPurpose: SettlementPurposePayable},
	{Code: "2202", Name: "应付账款", ParentCode: "2000", BalanceDirection: BalanceDirectionCredit, Dimensions: []string{DimensionSupplierRelationship}, SettlementPurpose: SettlementPurposePayable},
	...
	{Code: "2241", Name: "销售合作应付款", ParentCode: "2000", BalanceDirection: BalanceDirectionCredit, Dimensions: []string{DimensionSalesRelationship}, SettlementPurpose: SettlementPurposeOther},
