...
var enterpriseSubjectTemplate = []subjectTemplateLine{
	...
	{Code: "1121", Name: "应收票据", ParentCode: "1000", BalanceDirection: BalanceDirectionDebit, Dimensions: []string{DimensionCustomer, DimensionBill}, SettlementPurpose: SettlementPurposeReceivable},
	{Code: "1122", Name: "应收账款", ParentCode: "1000", BalanceDirection: BalanceDirectionDebit, Dimensions: []string{DimensionCustomer}, SettlementPurpose: SettlementPurposeReceivable},
	...
	{Code: "122102", Name: "其他单位往来", ParentCode: "1221", BalanceDirection: BalanceDirectionDebit, Dimensions: []string{DimensionOtherParty}, SettlementPurpose: SettlementPurposeOther},
	...
	{Code: "2203", Name: "预收账款", ParentCode: "2000", BalanceDirection: BalanceDirectionCredit, Dimensions: []string{DimensionCustomer}, SettlementPurpose: SettlementPurposeAdvanceReceipt},
	{Code: "2241", Name: "其他应付款", ParentCode: "2000", BalanceDirection: BalanceDirectionCredit, Dimensions: []string{DimensionOtherParty}, SettlementPurpose: SettlementPurposeOther},
