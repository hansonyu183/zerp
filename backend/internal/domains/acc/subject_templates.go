...
var enterpriseSubjectTemplate = []subjectTemplateLine{
	...
	{Code: "1121", Name: "应收票据", ParentCode: "1000", BalanceDirection: BalanceDirectionDebit, Dimensions: []string{DimensionCustomerSubunit, DimensionBill}, SettlementPurpose: SettlementPurposeReceivable},
	{Code: "1122", Name: "应收账款", ParentCode: "1000", BalanceDirection: BalanceDirectionDebit, Dimensions: []string{DimensionCustomerSubunit}, SettlementPurpose: SettlementPurposeReceivable},
	...
	{Code: "2203", Name: "预收账款", ParentCode: "2000", BalanceDirection: BalanceDirectionCredit, Dimensions: []string{DimensionCustomerSubunit}, SettlementPurpose: SettlementPurposeAdvanceReceipt},
