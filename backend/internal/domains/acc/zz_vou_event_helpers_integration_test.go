...
func approvedVOUEvent(snapshot voudomain.DocumentView) approval.Event[voudomain.DocumentView] {
	...
	return approval.Event[voudomain.DocumentView]{
		...
		FromRevision: &fromRevision, ToRevision: &toRevision, Payload: snapshot,
	}
}

func unapprovedVOUEvent(snapshot voudomain.DocumentView) approval.Event[voudomain.DocumentView] {
	approved := approval.StatusApproved
	pending := approval.StatusPending
