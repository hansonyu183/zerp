...
type applicationService interface {
	...
	CreateUserAs(context.Context, CreateUserInput, Principal, string) (UserDetail, error)
	SaveUserAs(context.Context, SaveUserInput, Principal, string) (UserDetail, error)
	SetUserStatusAs(context.Context, string, int64, string, Principal, string) (UserDetail, error)
	ResetUserPasswordAs(context.Context, ResetPasswordInput, Principal, string) (ResetPasswordResult, error)
	...
	QueryRoleDirectory(context.Context, PageRequest, Principal) (Page[RoleListItem], error)
	GetRoleDetail(context.Context, string, Principal) (RoleDetail, error)
	CreateRoleAs(context.Context, CreateRoleInput, Principal, string) (RoleDetail, error)
	SaveRoleAs(context.Context, SaveRoleInput, Principal, string) (RoleDetail, error)
	SetRoleStatusAs(context.Context, string, int64, string, Principal, string) (RoleDetail, error)
	QueryPermissions(context.Context, PageRequest) (Page[PermissionView], error)
	QueryPermissionsAs(context.Context, PageRequest, Principal) (Page[PermissionView], error)
	GetPermission(context.Context, string) (PermissionView, error)
	GetPermissionAs(context.Context, string, Principal) (PermissionView, error)
