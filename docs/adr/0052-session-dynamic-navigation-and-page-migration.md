...
partially_superseded_by: ADR-0055, ADR-0056, ADR-0058, ADR-0059, ADR-0060, ADR-0061
---
...
DCL 不在目标能力矩阵中。ADR-0053 至 ADR-0058 已完成 13 个原 DCL 实体逐项迁移，当前 DCL 无运行时路由、权限、菜单或写入方。必要旧表和转换命令保留历史证据及一次性迁移职责，不构成当前资料消费者。
