...
- 已实现资源及用例归属以 [Registry](../../../frontend/src/target/navigation/registry.ts) 和 [覆盖报告](../COVERAGE.md) 为准。Host 只负责资格、装配与页面实例生命周期；资源特有场景见 [APP 用户与角色](access-management.md)、[AUX 基础分类](../aux/basic-maintenance.md)、[AUX 人员](../aux/people-maintenance.md)及 [AUX 资产资源](../aux/assets-maintenance.md)。
