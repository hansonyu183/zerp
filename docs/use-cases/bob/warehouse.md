...
4. 每次查询直接连接 DCL subject、highest APPROVED Approval Entry 与仓库 typed snapshot；DCL 批准或反批后无需额外写入即可切换、回落或隐藏。仓库 Stable ID、编码和来源 Approval Entry ID 供库存、单据和历史引用追溯。
