...
- 路由：`/vou/expense-payment`，公共 Draft、查询、详情与生命周期编排见 [VOU 页面公共用例](README.md)。
- 业务不变量以 [VOU 领域文档](../../domains/vou.md#39-费用付款) 为准；请求与响应只采用可执行 Hono 路由。

## `VOU-EXPENSE-PAYMENT-01` 业务工作区

1. 只读呈现员工、资金账户、经办人和付款金额；由费用流程生成，不开放人工 Draft。
