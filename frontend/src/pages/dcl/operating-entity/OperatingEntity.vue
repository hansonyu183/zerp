...
const vm = reactive(useDclOperatingEntityViewModel())
const route = useRoute()
const router = useRouter()
const deleteTarget = ref<DclOperatingEntityListItem | null>(null)
...
<template>
  <v-container fluid class="dcl-operating-entity-page pa-5 pa-md-8">
  ...
  <v-navigation-drawer
    ...
    class="dcl-operating-entity-drawer"
    location="end"
    temporary
    width="720"
  >
    <div class="dcl-operating-entity-drawer__content">
      <BusinessObjectEditor
...
<style scoped>
.dcl-operating-entity-page {
  color: rgb(var(--v-theme-on-background));
}

.dcl-operating-entity-drawer {
  background: rgb(var(--v-theme-background));
}

.dcl-operating-entity-drawer__content {
  padding: 20px;
}
