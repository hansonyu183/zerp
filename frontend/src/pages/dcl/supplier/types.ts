...
export type DclSupplierVersionView =
  components['schemas']['DclSupplierVersionView']
...
export type DclSupplierEditContext = {
  objectId: string
  approvalEntryId: string
  approvalRevision: number
}

export type DclSupplierConfig = {
  columns: readonly BusinessObjectColumn<DclSupplierListItem>[]
  fields: readonly BusinessObjectField<DclSupplierForm>[]
  filters: readonly {
    key: 'status' | 'enabled'
    label: string
    type: 'select'
  ...
  emptyForm: () => DclSupplierForm
}

export function dclSupplierActiveVersion(
