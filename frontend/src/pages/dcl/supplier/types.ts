...
export type DclSupplierForm = { code: string; kind: 'PERSON' | 'ORGANIZATION'; legalName: string; displayName: string; legalIdentifier: string; enabled: boolean; operatingEntityIds: string[]; defaultOperatingEntityId: string; shortName: string; contactName: string; contactPhone: string; email: string; address: string; remark: string; settlementMethodId: string; defaultPurchaserEmployeeId: string }
